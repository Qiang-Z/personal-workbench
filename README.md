...
> 当前版本：**v4.5** — 信息热榜改造为克制、可稍后处理的信息简报。
...
v4.5 新增**网盘文件夹备份**，并改进工作项目管理的页面组织：

### 网盘文件夹备份
- 可选择 OneDrive、iCloud Drive、Dropbox、百度网盘等客户端的同步目录
- 无需账号密码或开发者密钥，每 24 小时最多自动生成一份，保留最近 30 份历史
- 支持手动恢复，恢复前自动创建本地快照
- 新增 `source/src/data/backup/cloud-folder.js` + `tests/cloud-folder-backup.test.js`

### 工作项目管理改进
- 项目支持整区折叠，单个项目卡也可独立收起
- 项目按「进行中 / 已完成」分区，已完成项目进入归档区
- 工作事项的「待完成 / 已完成」分开，完成记录默认收起
- 新增 `tests/work-projects.test.js`

完整说明见 `source/README.md`。
